...
class ControllerStartupStartup extends Controller
{
    public function index()
    {
        ...
        // Store default language (from DB) — main language has no URL prefix
        $this->config->set('config_language_main', $this->config->get('config_language'));
        ...
        // Keep config in sync with chosen language (session/cookie/browser/default)
